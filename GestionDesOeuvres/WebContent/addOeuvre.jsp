...
<c:choose>
	<c:when test="${flagSaisieModif==true}">
		...
		<c:set var="actionFormulaire" value="Controller?action=saveOrUpdateOeuvre"
			scope="page" />
	...
	<c:when test="${flagSaisieModif==false}">
		...
		<c:set var="actionFormulaire"
			value="Controller?action=saveOrUpdateOeuvre&id=${oeuvre.idOeuvrevente}" scope="page" />
	</c:when>
</c:choose>
...
<form method="post" action="${actionFormulaire}"
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" id="titre" name="titre" value="${oeuvre.titre}">
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" id="prix" name="prix" value="${oeuvre.prix}">
		</div>
	</div>
	<div class="control-group">
